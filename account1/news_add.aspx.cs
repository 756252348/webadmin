...
public partial class Account_news_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (id == null)
                id = "0";
            gid.Value = id;
            db.C_BindDataToDDL("select id,name from dbo.type where tag=0", DropDownList1);
            if (id != "0")
                dateBing(id);
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select(new string[] { "0", "22", id }, 5);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            String srlt = db.ExecProcRltJson("a_in_UpdtNewsInfo", listParams);
