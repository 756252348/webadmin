<%@ Page Language="C#" AutoEventWireup="true" CodeFile="type_list1.aspx.cs" Inherits="Account_type_list1" %>
    ...
    <script>
        $(function () {
            $("#up_btn").click(function () {
                ...
                if ($(".checked").size() > 0)
                {
                    window.location.href="type_add1.aspx?gid=" + $(".checked").parent().parent().parent().text().trim();
                }
                else {
                    alert("请选择商品修改");
                }
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='type_add1.aspx'" title="新增类别">
                                        <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="up_btn" title="修改类别">
