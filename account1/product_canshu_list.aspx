<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_canshu_list.aspx.cs" Inherits="Account_product_canshu_list" %>
    ...
    <script>
        $(function () {
            $("#up_btn").click(function () {
                ...
                if ($(".checked").size() > 0)
                {
                    var parantid=GetQueryString("gid");
                    window.location.href="product_canshu.aspx?gid=" + $(".checked").parent().parent().parent().text().trim()+"&parantid="+parantid;
                }
                else {
                    alert("请选择商品修改");
                }
            ...
            $("#add").click(function () {
                    var parantid = GetQueryString("gid");
                    window.location.href = "product_canshu.aspx?&parantid=" + parantid;
            });
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/decanshu.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='product_canshu.aspx'" title="新增参数" id="add">
                                        <i class="glyphicon glyphicon-plus" aria-hidden="true"></i> 
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="up_btn" title="修改参数">
                                        <i class="glyphicon glyphicon-edit" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="del_btn" title="删除参数">
