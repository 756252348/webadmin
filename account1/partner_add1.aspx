<%@ Page Language="C#" AutoEventWireup="true" CodeFile="partner_add1.aspx.cs" Inherits="Account_partner_add1" %>
                ...
                <div class="ibox-content">
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                       ...
                       <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                   <input name="pdt1" type="text" class="form-control" id="url" runat="server">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="保存内容" OnClick="btLogin_Click" />
                                 <button type="button" onclick="javascript:location.href='partner_list1.aspx'" class="btn btn-outline btn-default" title="返回">返回列表</button>
                            </div>
                        </div>
                    </form>
                </div>
