...
public partial class Account_type_add1 : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select1(new string[] { "0", "23", id }, 1);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            DataTable srlt = db.QueryDataRltRcrd("a_in_updttype1", listParams).Tables[0];
