<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_list1.aspx.cs" Inherits="Account_news_list1" %>
    ...
    <script>
        $(function () {
            $("#deliver").click(function () {
                window.location.href = "news_add1.aspx?id=" + $(".checked").parent().parent().parent().text().trim();
            })
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/deNews1.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                     <button id="deliver" type="button" class="btn btn-outline btn-default" title="修改新闻">
