<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Banner_list1.aspx.cs" Inherits="Account_Banner_list1" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#deliver").click(function () {
                ...
                location.href = "Banner_add1.aspx?id=" + strID;
            })
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/deBanner1.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='Banner_add1.aspx'" title="新增">
                                        <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                    </button>
                                    <button id="deliver" type="button" class="btn btn-outline btn-default" title="修改">
