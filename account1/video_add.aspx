<%@ Page Language="C#" AutoEventWireup="true" CodeFile="video_add.aspx.cs" Inherits="Account_video_add" %>
                    ...
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                        ...
                        <div id="form_lists" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="pdt1" type="text" class="form-control" id="pro_url" runat="server">
                                </div>
                            </div>  
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <button type="button" onclick="javascript:location.href='video_list.aspx'" class="btn btn-outline btn-default" title="返回">返回</button>
                            </div>
                        </div>
                    </form>
                </div>
