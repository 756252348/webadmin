...
public partial class Account_product_type_info1 : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select1(new string[] { "0", "20", id }, 5);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            DataTable srlt = db.QueryDataRltRcrd("a_in_UpdtPrdctTypeInfo1", listParams).Tables[0];
