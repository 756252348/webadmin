<%@ Page Language="C#" AutoEventWireup="true" CodeFile="type_add1.aspx.cs" Inherits="Account_type_add1" %>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="保存内容" OnClick="btLogin_Click" />
                                 ...
                                 <button type="button" onclick="javascript:location.href='type_list1.aspx'" class="btn btn-outline btn-default" title="返回">返回</button>
                            </div>
                        </div>
                    </form>
                </div>
