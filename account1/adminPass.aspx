<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminPass.aspx.cs" Inherits="Account_adminPass" %>
                    ...
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="修改密码" OnClick="btLogin_Click" />                 
                            </div>
                        </div>
                    </form>
                </div>
