<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_addsp.aspx.cs" Inherits="Account_product_addsp" ValidateRequest="false" %>
                    ...
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                        ...
                        <div id="form_lists" runat="server">
                            ...
                            <%--<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="pdt3" type="text" class="form-control" id="pro_zy" runat="server">
                                </div>
                            </div>--%>
                           <%-- <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="pdt4" type="text" class="form-control" id="pro_pp" runat="server">
                                </div>
                            </div>--%>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="保存内容" OnClick="btLogin_Click" />
                                 <button type="button" onclick="javascript:location.href='product_list.aspx'" class="btn btn-outline btn-default" title="返回">返回列表</button>
                            </div>
                        </div>
                    </form>
                </div>
