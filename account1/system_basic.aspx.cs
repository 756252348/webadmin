...
public partial class Account_system_basic : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select(new string[] { "0", "27", id }, 10);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            String srlt = db.ExecProcRltJson("a_in_UpdtSYSBasic", listParams);
