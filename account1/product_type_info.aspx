<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_type_info.aspx.cs" Inherits="product_type_info" %>
                    ...
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <button type="button" onclick="javascript:location.href='product_list.aspx'" class="btn btn-outline btn-default" title="返回">返回商品列表</button>
                            </div>
                        </div>
                    </form>
                </div>
