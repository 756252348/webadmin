<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_type.aspx.cs" Inherits="product_type" %>
        ...
        $(function () {
            $("#up_btn").click(function () {
                ...
                if ($(".checked").size() > 0)
                {
                    ...
                    window.location.href = "product_type_info.aspx?gid=" + $(".checked").parent().parent().parent().text().trim() + "&ParentId="+ParentId;
                }
                else {
                    alert("请选择规格修改");
                }
            ...
            $("#add_btn").click(function () {
                    var ParentId = GetQueryString("gid");
                    window.location.href = "product_type_info.aspx?&ParentId=" + ParentId;
            });
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/detype.ashx",
                        type: "POST",
                        async: true,
