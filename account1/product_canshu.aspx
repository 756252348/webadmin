<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_canshu.aspx.cs" Inherits="Account_product_canshu" %>
                    ...
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="保存内容" OnClick="btLogin_Click" /><button type="button" onclick="javascript:location.href='product_list.aspx'" class="btn btn-outline btn-default" title="返回">返回商品列表</button>                 
                            </div>
                        </div>
                    </form>
                </div>
