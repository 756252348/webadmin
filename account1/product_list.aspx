<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_list.aspx.cs" Inherits="Account_product_list" %>
    ...
    <script>
        $(function () {
            ...
            $("#canshu_btn").click(function () {
                ...
                if ($(".checked").size() > 0) {
                    window.location.href = "product_canshu_list.aspx?gid=" + $(".checked").parent().parent().parent().text().trim();
                }
                else {
                    alert("请选择商品修改产品参数");
                }
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='product_addsp.aspx'" title="新增商品">
