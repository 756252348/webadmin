<%@ Page Language="C#" AutoEventWireup="true" CodeFile="partner_list1.aspx.cs" Inherits="Account_partner_list1" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#deliver").click(function () {
                ...
                location.href = "partner_add1.aspx?id=" + strID;
            })
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/departner1.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='partner_add1.aspx'" title="新增类别">
