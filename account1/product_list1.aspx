<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_list1.aspx.cs" Inherits="Account_product_list1" %>
    ...
    <script>
        $(function () {
            $("#up_btn").click(function () {
                ...
                if ($(".checked").size() > 0)
                {
                    window.location.href="product_addsp1.aspx?gid=" + $(".checked").parent().parent().parent().text().trim();
                }
                else {
                    alert("请选择商品修改");
                }
            ...
            $("#type_btn").click(function () {
                ...
                if ($(".checked").size() > 0) {
                    window.location.href = "product_type1.aspx?gid=" + $(".checked").parent().parent().parent().text().trim();
                }
                else {
                    alert("请选择商品修改规格");
                }
            ...
            $("#canshu_btn").click(function () {
                ...
                if ($(".checked").size() > 0) {
                    window.location.href = "product_canshu_list1.aspx?gid=" + $(".checked").parent().parent().parent().text().trim();
                }
                else {
                    alert("请选择商品修改产品参数");
                }
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='product_addsp1.aspx'" title="新增商品">
                                        <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="up_btn" title="修改商品">
                                        <i class="glyphicon glyphicon-edit" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="del_btn" title="删除商品">
                                        <i class="glyphicon glyphicon-trash" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="type_btn" title="添加规格">
                                        <i class="glyphicon glyphicon-plus-sign" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="canshu_btn" title="修改产品参数">
