<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vip_examine.aspx.cs" Inherits="Account_vip_examine" %>
        ...
        $(function () {
            ...
            $("#cashCheck").click(function () {
                $.ajax({
                    ...
                    type: "POST",
                    async: true,
                    data: { cashId: $(".checked").eq(0).parent().parent().parent().text(), st: "1" },
                    cache: true,
                    dataType: "html",
                    beforeSend: function () { },
                    success: function (dt) {
            ...
            $("#cashRefuse").click(function () {
                $.ajax({
                    ...
                    type: "POST",
                    async: true,
                    data: { cashId: $(".checked").eq(0).parent().parent().parent().text(),st:"2" },
                    cache: true,
                    dataType: "html",
                    beforeSend: function () { },
                    success: function (dt) {
