...
public partial class Account_product_fenlei_list : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            listParams.Add("");
            listParams.Add("");
            tbl_list.InnerHtml = db.createHtmlTables(0, new string[] { "编号","类别名称","修改时间" }, new string[] { }, listParams, "a_out_PageList", false, new int[] { }, true, 0, 0);
