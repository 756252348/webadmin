<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_fenlei_list.aspx.cs" Inherits="Account_product_fenlei_list" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#deliver").click(function () {
                ...
                location.href = "product_addfenlei.aspx?id=" + strID;
            })
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/deFenlei.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='product_addfenlei.aspx'" title="新增类别">
