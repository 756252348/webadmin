<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderlist.aspx.cs" Inherits="Account_oderlist" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#deliver").click(function () {
                ...
                location.href = "fahuo.aspx?id="+strID;
            })
        });
...
<body class="gray-bg">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div id="editable_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    ...
                                    <button id="deliver" type="button" class="btn btn-outline btn-default" title="修改物流">
                        ...
                        <input class="outexc btn btn-primary" type="button" value="导出订单" onclick="CopyTable()"/>
    ...
    <script>
        ...
        function CopyTable() {
            window.open("AJAX/ExcelList.ashx?dataType=order");
