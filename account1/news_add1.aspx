<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_add1.aspx.cs" Inherits="Account_news_add1" %>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form runat="server" class="form-horizontal" id="nws_add">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input runat="server" type="text" class="form-control" id="bt">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input runat="server" type="text" class="form-control" id="zy">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="发布内容" OnClick="btLogin_Click" />
                                 <button type="button" onclick="javascript:location.href='news_list1.aspx'" class="btn btn-outline btn-default" title="返回">返回</button>
                            </div>
                        </div>
                    </form>
                </div>
