<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_list.aspx.cs" Inherits="Account_news_list" %>
    ...
    <script>
        $(function () {
            $("#deliver").click(function () {
                window.location.href = "news_add.aspx?id=" + $(".checked").parent().parent().parent().text().trim();
            })
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/deNews.ashx",
                        type: "POST",
                        async: true,
