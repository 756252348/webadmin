...
(function (w, i) {
    ...
    function U(a, b, c, d, e) {
        ...
        var f = [],
			a = a.replace(/(\s*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>(\s*)/g, function (a, n, q, r, K, ja, i) {
			    var n = n || "",
					q = q || "",
					l = r.toLowerCase(),
					o = K || "",
    ...
    function Qa(a, b, c) {
        ...
        function g(e, l) {
            for (var i = e.firstChild, o; i;) {
                ...
                if (m >= 0) return !1;
                o = i.nextSibling;
                if (n > 0) if (i.nodeType == 1) if (q >= 0 && r <= 0) b && l.appendChild(i.cloneNode(!0)), c && f.push(i);
                else {
                    var p;
    ...
    if (!w.KindEditor) {
        ...
        E(D, {
            ...
            pos: function () {
                var a = this[0],
					b = 0,
					c = 0;
                if (a) if (a.getBoundingClientRect) a = a.getBoundingClientRect(), c = ca(this.doc), b = a.left + c.x, c = a.top + c.y;
        ...
        E(oa, {
            ...
            selection: function (a) {
                ...
                this.sel = Sa(b);
                if (c) return this.range = Ra(c), f(this.range.startContainer).name == "html" && this.range.selectNodeContents(b.body).collapse(!1), this;
            ...
            select: function (a) {
                ...
                if (a && d.nodeType == 1 && c.collapsed) {
                    ...
                    if (X && (a = d.childNodes, f(d).isInline() || e > 0 && f(a[e - 1]).isInline() || a[e] && f(a[e]).isInline())) c.insertNode(g.createTextNode("\u200b")), k = !0
                }
                if (H) try {
                    j = c.get(!0), j.select()
            ...
            val: function (a) {
                ...
                if (a === "forecolor") return (a = this.commonNode({
                    "*": ".color"
                })) && (c = a.css("color")), c = ya(c), c === "" && (c = "default"), c.toLowerCase();
