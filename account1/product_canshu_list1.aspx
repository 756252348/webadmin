<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_canshu_list1.aspx.cs" Inherits="Account_canshu_list1" %>
        ...
        $(function () {
            $("#up_btn").click(function () {
                ...
                if ($(".checked").size() > 0)
                {
                    ...
                    window.location.href="product_canshu1.aspx?gid=" + $(".checked").parent().parent().parent().text().trim()+"&parantid="+parantid;
                }
                else {
                    alert("请选择商品修改");
                }
            ...
            $("#add").click(function () {
                    var parantid = GetQueryString("gid");
                    window.location.href = "product_canshu1.aspx?&parantid=" + parantid;
            });
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/decanshu1.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='product_canshu1.aspx'" title="新增参数" id="add">
