<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news_add.aspx.cs" Inherits="Account_news_add" %>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <asp:Button ID="btLogin" runat="server" class="btn btn-primary" Text="发布内容" OnClick="btLogin_Click" />
                                 <button type="button" onclick="javascript:location.href='news_list.aspx'" class="btn btn-outline btn-default" title="返回">返回</button>
                            </div>
                        </div>
                    </form>
                </div>
