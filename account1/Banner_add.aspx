<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Banner_add.aspx.cs" Inherits="Account_Banner_add" %>
                    ...
                    <form runat="server" class="form-horizontal" id="pro_addsp">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <button type="button" onclick="javascript:location.href='Banner_list.aspx'" class="btn btn-outline btn-default" title="返回">返回列表</button>
                            </div>
                        </div>
                    </form>
                </div>
