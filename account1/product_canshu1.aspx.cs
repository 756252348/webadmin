...
public partial class Account_product_canshu1 : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select1(new string[] { "0", "21", id }, 2);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            String srlt = db.ExecProcRltJson("a_in_UpdtPrdctcanshu1", listParams);
