...
public partial class Account_Banner_add : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select(new string[] { "0", "35", id }, 4);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            DataTable srlt = db.QueryDataRltRcrd("a_in_updtBanner", listParams).Tables[0];
