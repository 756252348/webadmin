<%@ Page Language="C#" AutoEventWireup="true" CodeFile="video_list.aspx.cs" Inherits="Account_video_list" %>
    ...
    <script>
        $(function () {
            $("#up_btn").click(function () {
                ...
                if ($(".checked").size() > 0)
                {
                    window.location.href="video_add.aspx?gid=" + $(".checked").parent().parent().parent().text().trim();
                }
                else {
                    alert("请选择商品修改");
                }
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='video_add.aspx'" title="新增视频">
                                        <i class="glyphicon glyphicon-plus" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="up_btn" title="修改视频">
                                        <i class="glyphicon glyphicon-edit" aria-hidden="true"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline btn-default" id="del_btn" title="删除视频">
