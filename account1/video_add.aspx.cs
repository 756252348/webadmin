...
public partial class Account_video_add : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select(new string[] { "0", "24", id }, 2);
        pro_name.Value = obj[0].ToString();
        pro_url.Value = obj[1].ToString();
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            DataTable srlt = db.QueryDataRltRcrd("a_in_updtvideo", listParams).Tables[0];
