...
public partial class Account_product_addsp : System.Web.UI.Page
{
   ...
   protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (id == null)
                id = "0";
            gid.Value = id;
            db.C_BindDataToDDL("select ID,name from dbo.proct_fenlei where Tag=0", DropDownList1);
            if (id != "0")
                dateBing(id);
        }
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select(new string[] {"0","15",id },5);
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            DataTable srlt = db.QueryDataRltRcrd("a_in_UpdtPrdctInfo", listParams).Tables[0];
