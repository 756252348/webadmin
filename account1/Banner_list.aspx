<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Banner_list.aspx.cs" Inherits="Account_Banner_list" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#deliver").click(function () {
                ...
                location.href = "Banner_add.aspx?id=" + strID;
            })
            $("#del_btn").click(function () {

                if ($(".checked").size() > 0) {
                    $.ajax({
                        url: "ajax/deBanner.ashx",
                        type: "POST",
                        async: true,
                        ...
                        <div class="fixed-table-toolbar">
                            ...
                            <div class="bars pull-left">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button type="button" class="btn btn-outline btn-default" onclick="window.location.href='Banner_add.aspx'" title="新增">
