...
public partial class Account_partner_add1 : System.Web.UI.Page
{
    ...
    private void dateBing(string id)
    {
        ...
        obj = db.C_Proc_Select1(new string[] { "0", "36", id }, 3);
        url.Value = obj[0].ToString();
        pro_name.Value = obj[2].ToString();
    ...
    protected void btLogin_Click(object sender, EventArgs e)
    {
        ...
        if (db.getPostFormValues(Request, ref listParams1))
        {
            ...
            DataTable srlt = db.QueryDataRltRcrd("a_in_updtpartner1", listParams).Tables[0];
