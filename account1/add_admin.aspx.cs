...
public partial class Account_add_admin : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        listParams.Add("1");
        listParams.Add("");
        form_lists.InnerHtml = db.createFormBill(new int[] { 0, 0, 0, 0 }, new string[] { "用户名", "密码", "时间", "角色" }, listParams, "a_out_sglList", null);
